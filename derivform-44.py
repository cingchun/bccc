...
#            Des:   40 -> remove state's degeneracy
...
def iter2code():
    ...
    with open(F'bccc{ossep}{fpre}.py', 'w') as fout:
        ...
        write(F'    sl = {s2l[1:]}\n')
        write( '    tud = [tuple(sorted(zip(bl,sl))) for bl,sl in product(permutations(list(range(npo)),r=2), sl)]  # independent t\n ')
        write( '    \n')
        ...
        write( '        l = libta.ta(tl, pul, il, nu, rll, npo, h, no, g, lT0, n2, p, nc)\n')
        ...
        write( '        dd = {u: (h0d.get(u, 0.0)+td[u]+(hu-E0)*sum(s*prodl([t0[v] for v in vl]) for s,vl in tu))/(xE+hu-E0) for u,(hu,tu) in hud.items() if u in tud}\n')
        write( '        t = {u: t0[u]-du for u,du in dd.items()}\n')
        write( '        for A in range(nc,npo):\n')
        write( '            for B in range(A+1,npo):\n')
        write( '                t[((A,1),(B,3))]=t[((A,2),(B,3))]=t[((A,3),(B,1))]=t[((A,3),(B,2))]=0.0\n')
        write( '                t[((A,4),(B,5))]=t[((A,5),(B,4))]=-t[((A,3),(B,3))]\n')
        write( '                t[((A,9),(B,11))]=-t[((A,7),(B,13))]; t[((A,11),(B,9))]=-t[((A,13),(B,7))]\n')
        write( '                t[((A,9),(B,12))]=-t[((A,7),(B,14))]; t[((A,12),(B,9))]=-t[((A,14),(B,7))]\n')
        write( '                t[((A,10),(B,11))]=-t[((A,8),(B,13))]; t[((A,11),(B,10))]=-t[((A,13),(B,8))]\n')
        write( '                t[((A,10),(B,12))]=-t[((A,8),(B,14))]; t[((A,12),(B,10))]=-t[((A,14),(B,8))]\n')
        write( '        t0 = {v:s*t[u] for u,ud in udd.items() for v,s in ud.items()}\n')
